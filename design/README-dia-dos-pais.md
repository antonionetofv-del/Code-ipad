...
>
> Porque um dia a gente repete o jeito de levar a vida
...
O remate é do cliente. Na revisão saíram três correções de digitação: *lavar* → **levar**,
o *é* virou **e** (a frase pede conjunção, não verbo) e faltava o **era** em "que já era
dele".
